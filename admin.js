...
// Inside the loadComplaints function in admin.js
function loadComplaints() {
    ...
    if (complaints.length === 0) {
        ...
        noComplaintsItem.innerHTML = '<p class="text-center text-secondary">No complaints registered yet.</p>';
        complaintList.appendChild(noComplaintsItem);
        return;
    }
